...
public class TblBitacoraEntity {
    ...
    public boolean equals(Object o) {
        ...
        TblBitacoraEntity that = (TblBitacoraEntity) o;

        if (comentario != null ? !comentario.equals(that.comentario) : that.comentario != null) return false;
        if (fechaComent != null ? !fechaComent.equals(that.fechaComent) : that.fechaComent != null) return false;
