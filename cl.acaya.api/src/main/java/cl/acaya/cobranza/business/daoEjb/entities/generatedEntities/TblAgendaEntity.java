...
public class TblAgendaEntity {
    ...
    public boolean equals(Object o) {
        ...
        TblAgendaEntity that = (TblAgendaEntity) o;

        if (fecAgenda != null ? !fecAgenda.equals(that.fecAgenda) : that.fecAgenda != null) return false;
        ...
        if (realizada != null ? !realizada.equals(that.realizada) : that.realizada != null) return false;
